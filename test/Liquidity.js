...
contract('MAI', function (accounts) {
    constructor(accounts)
     addLiquidity(addressETH, _1BN, _dot01)
...
function addLiquidity(address, amountM, amountA){
    ...
    let txApproval = await instanceMAI.approve(addressMAI, amountM, {from:acc0})
    let addMai = await instanceMAI.addLiquidityToEtherPool(amountM, { from: acc0, value:amountA})
